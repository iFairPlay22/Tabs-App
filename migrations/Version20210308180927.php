 ...
 */
final class Version20210308180927 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE song (id INT AUTO_INCREMENT NOT NULL, band_id INT NOT NULL, tag_id INT DEFAULT NULL, capo VARCHAR(10) NOT NULL, song_name VARCHAR(30) NOT NULL, group_name VARCHAR(30) NOT NULL, content LONGTEXT NOT NULL, lyrics LONGTEXT DEFAULT NULL, INDEX IDX_33EDEEA149ABEB17 (band_id), INDEX IDX_33EDEEA1BAD26311 (tag_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles VARCHAR(250) NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE song ADD CONSTRAINT FK_33EDEEA1BAD26311 FOREIGN KEY (tag_id) REFERENCES tag (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE song DROP FOREIGN KEY FK_33EDEEA1BAD26311');
