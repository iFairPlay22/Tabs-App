 ...
 */
final class Version20201102151646 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE song (id INT AUTO_INCREMENT NOT NULL, band_id INT NOT NULL, capo VARCHAR(10) NOT NULL, song_name VARCHAR(30) NOT NULL, group_name VARCHAR(30) NOT NULL, content VARCHAR(10000) NOT NULL, INDEX IDX_33EDEEA149ABEB17 (band_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
